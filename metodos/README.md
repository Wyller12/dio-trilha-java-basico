//De preferência métodos devem ser nomeados como verbo eSeguir o padrão camelCase (Todas as letras minúsculas com a exceção da primeira letra da segunda palavra).
